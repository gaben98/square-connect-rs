...
**sort_field** | Option<[**ListPaymentRefundsRequestSortField**](ListPaymentRefundsRequestSortField.md)> | The field used to sort results by. The default is `CREATED_AT`. |  |
