...
**sort_order** | Option<[**SortOrder**](SortOrder.md)> | The order in which cash drawer shifts are listed in the response, based on their opened_at field. Default value: ASC |  |
